...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <!--FIM DO MENU-->
     <div class="crumb_navigation"> Navigation: <a href="index.php">Home</a> &lt; <span class="current">Login</span> </div>
    ...
    <div class="center_content">
      ...
      <div class="prod_box_big">
        ...
        <form method="post" name="login" action="sessao.php" >
              <label class="contact"><strong>Usuário:</strong></label>
              <input name="lala" type="text" class="contact_input" />
             <div class="form_row">
              <label class="contact"><strong>Senha:</strong></label>
              <input name="senh" type="password" class="contact_input" />
              <?php 
              echo "<label name='errinho' style='color:red'>".@$poloti." </label>" 
              ?>
            </div>
          <div class="erikfeio">
        <label class="erikgordo"> <a class="ccc" href="cadastro.php">Cadastre-se</a> </label>
        <label class="erikbarriga"> <a class="ddd" href="cadastro.php">Esqueceu sua senha?</a></label> </div> 
        <input type="submit" value="Entrar" />
        </form> 
        <!-- <div class="form_row"><a href="teste2.php" style="border-color:black"class="contact">Entrar</a></div> </input> -->
        </div>
        <div class="bottom_prod_box_big"></div>
      </div>     
      <br> </br>
     </div>
    <!--FIM DA PARTE DO CENTRO-->
