...
<div id="main_container">
      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          <div class="contact_form">
            <label class="zzz" style="color:red">Cadastro concluído com sucesso!</label>
            <br></br>
			<label class="yyy">Para acessar a sua conta, vá até a página inicial e efetue o login.</label>
            </div>      
          </div>
  ...
  <div class="footer">
    ...
    <div class="right_footer"> <a href="">home</a> <a href="contact.php">contato</a> </div>
  </div>
</div>
