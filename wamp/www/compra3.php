...
<script language="JavaScript" type="text/javascript" src="js3.txt"></script>
...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">Finalizar Compra</div>
      <div class="prod_box_big">
        <div class="top_prod_box_big"></div>
        <div class="center_prod_box_big">
        	<p class="aaa"> <div class="rrr">Valor dos Produtos:</div> <label class="zzz"> R$ 3.578,00 </label></p><br />
       		<p class="aaa"> <div class="rrr">Valor do Frete:</div> <label class="zzz"> R$ 38,00 </label> </p> <br />
 			<p class="aaa"> <div class="rrr">Valor Total:</div> <label class="zzz"> R$ 3.616,00 </label> </p> <br />
 			<p class="aaa"> <div class="rrr">Modo de Pagamento:</div> <label class="zzz"> Cart�o - 12x sem juros de R$ 298,17 </label> </p> <br />

         <center><a href="compra4.php" class="iii">Finalizar</a> <br /></center>
