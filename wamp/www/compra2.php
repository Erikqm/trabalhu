...
<div id="main_container">
  ...
  <div id="main_content">
    <div id="menu_tab">
      <div class="left_menu_corner"></div>
      	<ul class="menu">
        	...
        	<li class="divider"></li>
        	<li><a href="login2.php" class="nav6">Administrador</a></li>
        	<li class="divider"></li>
        	</li>
      	</ul>
    ...
    <div class="center_content">
      <div class="center_title_bar">Entrega - Passo 3</div>
      <div class="prod_box_big">
        ...
        <div align="center" class="center_prod_box_big">
         ...
         <label class="zzz">Digite o CEP para entrega do produto.</label>
         <br /> <br />
         <div class="contact_form">
            <div class="form_row">
            <label for="CEP">
            	
   		    <input class="contact_input" type="text" name="CEP" id="CEP" required pattern="\d{5}-?\d{3}" /> </label>
            </div> </div>
            <br />
            <br />
            <br />
         <center><a href="compra3.php" class="iii">Confirmar</a> <br />
         	<br />
        </div>
