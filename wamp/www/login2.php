      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          <div class="contact_form">
          	<label style="color:red" class="zzz">Usuário ou senha inválida!</label>
            <br></br>
			<label style="color:red" class="yyy">Por favor tente novamente.</label>
            <div class="form_row">
        ...
        <label class="erikbarriga"> <a class="ddd" href="esquecisenha.php">Esqueceu sua senha?</a></label> </div> 
                      <div class="form_row"><a href="compra1.php" class="contact">Enviar</a></div>
        </div>
