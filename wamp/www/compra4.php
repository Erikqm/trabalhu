    ...
    <div class="center_content">
      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
        	<p class="aaa"> <div class="rrr">Compra Finalizada!<br />Pedido número 304123 criado.</div> </p><br />
       		<p align="center" class="www"> <label class="zzz">Você pode verificar o status do pedido na página Minha Conta.</label> </p> <br />
 			<p align="center" class="www"> <label class="zzz">Um e-mail foi enviado para você com todos os detalhes do seu pedido, e com os passos para prosseguir com o pagamento.</label> </p> <br />
